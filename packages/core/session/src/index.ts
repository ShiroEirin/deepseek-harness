...
export class Session {
  ...
  append<T extends SessionEventType>(
    ...
    ...opts: T extends SurfaceEventType ? [opts: SurfaceIntent & SessionAppendOptions] : [opts?: SessionAppendOptions]
  ): SessionEvent<T> {
    const surfaceOpts = opts[0] as (SurfaceIntent & SessionAppendOptions) | undefined
